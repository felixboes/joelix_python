\begin{aufg}
  Auf der Kurswebseite findest du eine teilweise implementierte Klasse \lpy{Polynom}.
  
  Implementiere eine Klasse \lpy{Polynom}, welche ein Polynom mit rationalen 
